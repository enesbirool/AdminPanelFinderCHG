...
|                                                    |
|                                                    |
|          Cheeky's Hack Team Admin Finder V 1.0     |  
|                                                    |
|    Author=mXBozkurt                                |
|    T.E.M= || A L P H A || Clayziyy || Sadrazam ||  |
|       || Mr.Vortex || Jroken || Tegn ||            |
|                                                    |
|       Kimine göre lameriz,kimine göre hackeriz     |
|       Kimine göre uşak,kimine göre efendiyiz       |
|       İsteyen istediğini söylesin,                 |
|       ağzınız torba değil ki büzemeyiz             |
|       Biz sanalın cengaverleri,Cheeky's Ailesiyiz  |  
|                                                    |
|          VALIĞIMIZ TÜRK MİLLETİNE BAĞLIDIR         |
|                                                    |
|                                                    |
|====================================================|                                             
""")
...
kelimeler = ('admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for kelime in kelimeler:
    ...
    try:
        ...
        print("                                             ")
        print(":: Admin Sayfası Bulundu :: ===> "+sonuc)
